...
async function runQuery(question: string) {
  ...
  const vectorStore = await SimpleVectorStore.load(vectorStorePath, createEmbeddings());
  const hits = await vectorStore.similaritySearchWithScore(question, RAG_TOP_K);
